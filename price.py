...
from nobitex import get_prices_and_save
...
async def lifespan(app: FastAPI):
    scheduler.add_job(get_prices_and_save, "interval", minutes=5)
    scheduler.start()
    print("زمان‌بند روشن شد — هر ۵ دقیقه قیمت‌ها به‌روزرسانی می‌شن")

    yield

    scheduler.shutdown()
    print("زمان‌بند خاموش شد")
